          ...
          <div className="flex-grow-1 nav-padding">
            <div className="home-content pt-1">
              ...
              <p className="about-text px-5">
                ...
                <p className="about-text px-5"> 
                While numerous mood trackers enable you to log activities, we have yet to find another app on the market that combines both mood and habit tracking. This is the heart of iKaizen's functionality. We hope that as you track your progress over time, you will find clarity about how your moods affect your daily well-being and growth. Kaizen teaches us that even 1% improvement counts! </p>
                
                <p className="about-text px-5">
                Furthermore, we found that the majority of trackers on the market have limited abilities to track the full spectrum of human emotions. Our mood tracker offers multiple selections from approximately 30 different emotions. This is keeping in line with the latest research from UC Berkeley, which identified 27 distinct categories of emotion. In this way, we honor our feelings in order to journey with them on the kaizen path. </p>
                <p className="px-5"></p>
                <p className="pt-5"></p>
